...
import {
  LimitsModal
} from "./chunk-OAOKAICS.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-M6VEGVX4.js";
import {
  getStageColorByHex
} from "./chunk-PJDTUMID.js";
import {
...
} from "./chunk-XWDHFF62.js";
import {
  useTypedSelector
} from "./chunk-HOD62BHE.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-PPVQWW2X.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-NFKMQIJS.js";
import {
  index
} from "./chunk-3FRZR7RY.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-7LPPXR65.js";
import {
  useConfig
} from "./chunk-IH5JAQ2T.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  useDocumentActions
} from "./chunk-ADPBHZC3.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-CJR6NLKV.js";
import {
  PERMISSIONS,
  reducer,
  reducer2,
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/pl.json":
      return import("./pl.json-NPTVC66M.js");
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-VNNDG2BC.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
function __variableDynamicImportRuntime1__2(path) {
  switch (path) {
    ...
    case "./translations/pl.json":
      return import("./pl.json-LRSRBV2I.js");
    case "./translations/pt-BR.json":
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-ZTDDI3PI.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-JEEQX4UR.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-TYD2W7XP.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-YDA4S63H.js");
        return {
...
function __variableDynamicImportRuntime1__3(path) {
  switch (path) {
    ...
    case "./translations/pl.json":
      return import("./pl.json-VSHSDMFN.js");
    case "./translations/ru.json":
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-53QPJGUT.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-5FVLQTOJ.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-ECCYQDGU.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-WMZHPC3E.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-TZHNCMI5.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-K74ECXEU.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-HD5GXKN3.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-WONIU6CE.js");
          return {
...
//# sourceMappingURL=chunk-NAVPA4ZL.js.map
