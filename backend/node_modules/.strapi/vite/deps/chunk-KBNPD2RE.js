import {
  MagicLinkCE,
  SelectRoles
} from "./chunk-GO6G7YPR.js";
import {
  useEnterprise
} from "./chunk-TUVTRC7D.js";
import {
  SearchInput
...
var ModalForm = ({ onToggle }) => {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-7ZNCFTNG.js")).MagicLinkEE);
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-5ZFISULR.js")).CreateActionEE);
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-3E64AXPT.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-KBNPD2RE.js.map
