...
var pl = {
  ...
  "attribute.blocks": "Tekst sformatowany (Blocks)",
  "attribute.blocks.description": "Edytor tekstu oparty na JSON",
  ...
  "error.contentType.singularName-equals-pluralName": "Ta wartość nie może być taka sama jak API ID w liczbie mnogiej innego typu treści",
  "error.contentType.pluralName-equals-singularName": "Ta wartość nie może być taka sama jak API ID w liczbie pojedynczej innego typu treści",
  "error.contentType.pluralName-equals-collectionName": "Ta wartość jest już używana przez inny typ treści",
  ...
  "error.validation.enum-duplicate": "Zduplikowane wartości nie są dozwolone (tylko znaki alfanumeryczne są brane pod uwagę)",
  "error.validation.enum-empty-string": "Puste pola nie są dozwolone",
  "error.validation.enum-regex": "Co najmniej jedna wartość jest nieprawidłowa. Wartości muszą mieć co najmniej jeden znak alfabetyczny przed pierwszym wystąpieniem cyfry.",
  ...
  "form.attribute.item.uniqueField.v5.willBeDisabled": "Obecnie pole unikalne nie działa dobrze w komponentach. Jeśli wyłączysz tę funkcję, pole zostanie wyłączone do czasu naprawy.",
  "form.attribute.item.uniqueField.v5.disabled": "Obecnie pole unikalne nie działa dobrze w komponentach. To pole zostało wyłączone do czasu naprawy.",
  ...
  "IconPicker.search.placeholder.label": "Szukaj ikony",
  "IconPicker.search.clear.label": "Wyczyść wyszukiwanie ikon",
  "IconPicker.search.button.label": "Przycisk wyszukiwania ikon",
  "IconPicker.remove.tooltip": "Usuń wybraną ikonę",
  "IconPicker.remove.button": "Przycisk usuwania wybranej ikony",
  "IconPicker.emptyState.label": "Nie znaleziono ikon",
  "IconPicker.icon.label": "Wybierz ikonę {icon}",
  "chat.tooltips.close-chat": "Zamknij czat",
  "chat.tooltips.create-chat": "Nowy czat",
  ...
  "chat.input.defaults.ctb": "Opowiedz mi o Kreatorze typu treści",
  "chat.input.defaults.strapi": "Opowiedz mi o Strapi",
  "chat.input.thinking": "Strapi AI myśli...",
...
//# sourceMappingURL=pl.json-NPTVC66M.js.map
