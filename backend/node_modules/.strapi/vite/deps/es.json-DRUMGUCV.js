...
// node_modules/@strapi/admin/dist/admin/admin/src/translations/es.json.mjs
...
var dark = "Oscuro";
var light = "Claro";
var noPreview = "No hay vista previa disponible";
var or = "O";
var selectButtonTitle = "Seleccionar";
...
var es = {
  ...
  "HomePage.widget.error": "No se ha podido cargar el contenido del widget.",
  "HomePage.widget.loading": "Cargando contenido del widget",
  "HomePage.widget.no-data": "No se ha encontrado contenido.",
  ...
  "Settings.apiTokens.ListView.headers.createdAt": "Creado en",
  "Settings.apiTokens.ListView.headers.description": "Descripción",
  "Settings.apiTokens.ListView.headers.lastUsedAt": "Usado por última vez",
  "Settings.apiTokens.ListView.headers.name": "Nombre",
  ...
  "Settings.apiTokens.createPage.BoundRoute.title": "Ruta enlazada a",
  "Settings.apiTokens.createPage.permissions.description": "Las acciones vinculadas a una ruta se listan abajo.",
  "Settings.apiTokens.createPage.permissions.header.hint": "Selecciona las acciones de la aplicación o del plugin y haz clic en el icono de engranaje para mostrar la ruta vinculada.",
  "Settings.apiTokens.createPage.permissions.header.title": "Ajustes avanzados",
  "Settings.apiTokens.createPage.permissions.title": "Permisos",
  ...
  "Settings.apiTokens.regenerate": "Re-generar",
  "Settings.apiTokens.title": "Tokens de API",
  "Settings.application.customization": "Personalización",
  "Settings.application.customization.auth-logo.carousel-hint": "Sustituye el logotipo en las páginas de autenticación",
  ...
  "Settings.application.customization.carousel.auth-logo.title": "Logo de autenticación",
  "Settings.application.customization.carousel.change-action": "Cambiarlogo",
  "Settings.application.customization.carousel.menu-logo.title": "Logo de menú",
  ...
  "Settings.application.customization.menu-logo.carousel-hint": "Reemplaza el logo en la navegación del menú principal",
  ...
  "Settings.application.customization.size-details": "Dimensiones máx: {dimension}×{dimension}, Tamaño del archivo máx: {size}KB",
  ...
  "Settings.application.ee-or-ce": "{communityEdition, select, true {Edición comunitaria} other {Edición Empresarial}}",
  "Settings.application.ee.admin-seats.add-seats": "{isHostedOnStrapiCloud, select, true {Añadir asientos} other {contactar con ventas}}",
  "Settings.application.ee.admin-seats.at-limit-tooltip": "Al límite: añade más asientos para añadir más usuarios",
  ...
  "Settings.content-history.description": "Obtén más control sobre cada paso del ciclo de vida de tu contenido.",
  "Settings.content-history.not-available": "El historial de contenido sólo está disponible como parte de un plan de pago. Actualiza para tener un control total sobre el ciclo de vida de tu contenido.",
  "Settings.content-history.title": "Historial del contenido",
  "Settings.error": "Error",
  "Settings.global": "Configuración global",
  "Settings.permissions": "Panel de administración",
  "Settings.permissions.auditLogs.action": "Acción",
  "Settings.permissions.auditLogs.admin.auth.success": "Admin login",
  "Settings.permissions.auditLogs.admin.logout": "Admin logout",
  "Settings.permissions.auditLogs.component.create": "Crear componente",
  "Settings.permissions.auditLogs.component.delete": "Eliminar componente",
  "Settings.permissions.auditLogs.component.update": "Actualizar componente",
  "Settings.permissions.auditLogs.content-type.create": "Crear tipo de contenido",
  "Settings.permissions.auditLogs.content-type.delete": "Eliminar tipo de contenido",
  "Settings.permissions.auditLogs.content-type.update": "Actualizar tipo de contenido",
  "Settings.permissions.auditLogs.date": "Fecha",
  "Settings.permissions.auditLogs.details": "Detalles del registro",
  "Settings.permissions.auditLogs.entry.create": "Crear entrada{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.entry.delete": "Eliminar entrada{model, select, undefined {} other { ({model})}}",
  ...
  "Settings.permissions.auditLogs.entry.update": "Actualizar entrada{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.filters.combobox.aria-label": "Busca y selecciona una opción para filtrar",
  "Settings.permissions.auditLogs.listview.header.subtitle": "Registros de todas las actividades realizadas en su entorno",
  "Settings.permissions.auditLogs.media.create": "Crear media",
  "Settings.permissions.auditLogs.media.delete": "Eliminar media",
  "Settings.permissions.auditLogs.media.update": "Actualizar media",
  "Settings.permissions.auditLogs.not-available": "Los registros de auditoría sólo están disponibles como parte de un plan de pago. Actualiza para obtener una visualización de todas las actividades con capacidad de búsqueda y filtrado.",
  "Settings.permissions.auditLogs.payload": "Payload",
  "Settings.permissions.auditLogs.permission.create": "Crear permiso",
  "Settings.permissions.auditLogs.permission.delete": "Eliminar permiso",
  "Settings.permissions.auditLogs.permission.update": "Actualizar permiso",
  "Settings.permissions.auditLogs.role.create": "Crear rol",
  "Settings.permissions.auditLogs.role.delete": "Eliminar rol",
  "Settings.permissions.auditLogs.role.update": "Actualizar rol",
  "Settings.permissions.auditLogs.user": "Usuario",
  "Settings.permissions.auditLogs.user.create": "Crear usuario",
  "Settings.permissions.auditLogs.user.delete": "Eliminar usuario",
  "Settings.permissions.auditLogs.user.fullname": "{firstname} {lastname}",
  "Settings.permissions.auditLogs.user.update": "Actualizar usuario",
  "Settings.permissions.auditLogs.userId": "ID de usuario",
  ...
  "Settings.permissions.users.active": "Activo",
  ...
  "Settings.permissions.users.inactive": "Inactivo",
  ...
  "Settings.permissions.users.sso.provider.error": "Se ha producido un error al solicitar la configuración SSO",
  ...
  "Settings.permissions.users.user-status": "Estado del usuario",
  "Settings.permissions.users.username": "Nombre de usuario",
  ...
  "Settings.profile.form.section.experience.mode.option-system-label": "Usar ajustes del sistema",
  ...
  "Settings.sso.form.localAuthenticationLock.description": "Seleccione los roles para los que desea desactivar la autenticación local",
  "Settings.sso.form.localAuthenticationLock.label": "Bloqueo de autenticación local",
  ...
  "Settings.sso.not-available": "SSO sólo está disponible como parte de un plan de pago. Actualiza para configurar métodos adicionales de inicio y registro para el panel de administración.",
  ...
  "Settings.tokens.duration.30-days": "30 días",
  "Settings.tokens.duration.7-days": "7 días",
  "Settings.tokens.duration.90-days": "90 días",
  "Settings.tokens.duration.expiration-date": "Fecha de expiración",
  "Settings.tokens.duration.unlimited": "Ilimitado",
  "Settings.tokens.form.description": "Descripción",
  "Settings.tokens.form.duration": "Duración del token",
  "Settings.tokens.form.name": "Nombre",
  "Settings.tokens.form.type": "Tipo de token",
  "Settings.tokens.notification.copied": "Token copiado al portapapeles.",
  "Settings.tokens.popUpWarning.message": "¿Seguro que quieres regenerar este token?",
  ...
  "Settings.transferTokens.addFirstToken": "Añade tu primer token de transferencia",
  "Settings.transferTokens.addNewToken": "Añadir nuevo token de transferencia",
  "Settings.transferTokens.create": "Crear nuevo token de transferencia",
  "Settings.transferTokens.createPage.title": "Crear nuevo token de transferencia",
  "Settings.transferTokens.description": "Lista de tokens de transferencia creados",
  "Settings.transferTokens.emptyStateLayout": "Todavía no tienes contenido...",
  "Settings.transferTokens.title": "Tokens de transferencia",
  ...
  "Settings.webhooks.event.select": "Seleccionar evento",
  "Settings.webhooks.events.create": "Crear",
  "Settings.webhooks.events.delete": "Eliminar webhook",
  "Settings.webhooks.events.isLoading": "Cargando eventos",
  ...
  "Settings.webhooks.list.loading.success": "Webhooks cargados",
  ...
  "Settings.webhooks.validation.key": "Key es obligatorio",
  "Settings.webhooks.validation.name.regex": "TEl nombre debe empezar por una letra y contener únicamente letras, números, espacios y guiones bajos.",
  "Settings.webhooks.validation.name.required": "El nombre es obligatorio",
  "Settings.webhooks.validation.url.regex": "El valor debe ser una Url válida",
  "Settings.webhooks.validation.url.required": "Url es obligatorio",
  "Settings.webhooks.validation.value": "Un valor es requerido",
  ...
  "admin.pages.MarketPlacePage.filters.categories": "Categorías",
  "admin.pages.MarketPlacePage.filters.categoriesSelected": "{count, plural, =0 {Sin categorías} one {# categoría} other {# categorías}} selected",
  "admin.pages.MarketPlacePage.filters.collections": "Colecciones",
  "admin.pages.MarketPlacePage.filters.collectionsSelected": "{count, plural, =0 {Sin colecciones} one {# colección} other {# colecciones}} selected",
  ...
  "admin.pages.MarketPlacePage.plugin.downloads": "Este plugin tiene {downloadsCount} descargas semanales",
  "admin.pages.MarketPlacePage.plugin.githubStars": "Este plugin tiene {starsCount} estrellas en GitHub",
  ...
  "admin.pages.MarketPlacePage.plugin.version": 'Actualiza tu versión de Strapi: "{strapiAppVersion}" a: "{versionRange}"',
  "admin.pages.MarketPlacePage.plugin.version.null": 'No se ha podido verificar la compatibilidad con tu versión de Strapi: "{strapiAppVersion}"',
  "admin.pages.MarketPlacePage.plugins": "Plugins",
  "admin.pages.MarketPlacePage.provider.downloads": "Este proveedor tiene {downloadsCount} descargas semanales",
  "admin.pages.MarketPlacePage.provider.githubStars": "Este proveedor tiene {starsCount} estrellas en GitHub",
  ...
  "admin.pages.MarketPlacePage.sort.alphabetical": "Órden alfabético",
  "admin.pages.MarketPlacePage.sort.alphabetical.selected": "Ordenar por órden alfabético",
  "admin.pages.MarketPlacePage.sort.githubStars": "Número de estrellas en Github",
  "admin.pages.MarketPlacePage.sort.githubStars.selected": "Ordenar por estrellas en Github",
  "admin.pages.MarketPlacePage.sort.label": "Ordenar por",
  "admin.pages.MarketPlacePage.sort.newest": "Más nuevo",
  "admin.pages.MarketPlacePage.sort.newest.selected": "Ordenar por más nuevo",
  "admin.pages.MarketPlacePage.sort.npmDownloads": "Número de descargas",
  "admin.pages.MarketPlacePage.sort.npmDownloads.selected": "Ordenar por descargas de npm",
  ...
  "app.component.table.read": "Leer {target}",
  "app.component.table.select.one-entry": "Seleccionar {target}",
  "app.component.table.view": "Detalles de{target}",
  ...
  "app.components.BlockLink.cloud.content": "Alojamiento en la nube totalmente gestionado para tu proyecto Strapi.",
  ...
  "app.components.NpsSurvey.banner-title": "¿Qué probabilidades hay de que recomiendes Strapi a un amigo o compañero?",
  "app.components.NpsSurvey.dismiss-survey-label": "Cerrar encuesta",
  "app.components.NpsSurvey.feedback-question": "¿Tienes alguna sugerencia de mejora?",
  "app.components.NpsSurvey.feedback-response": "¡Muchas gracias por tu feedback!",
  "app.components.NpsSurvey.happy-to-recommend": "Extremadamente probable",
  "app.components.NpsSurvey.no-recommendation": "Nada probable",
  ...
  "app.components.Onboarding.link.build-content": "Construye una arquitectura de contenido",
  "app.components.Onboarding.link.manage-content": "Añade y gestiona contenidos",
  "app.components.Onboarding.link.manage-media": "Gestiona media",
  "app.components.Onboarding.link.more-videos": "Ver más videos",
  ...
  "app.utils.ready-to-publish": "Listo para publicar",
  "app.utils.ready-to-publish-changes": "Listo para publicar cambios",
  "app.utils.ready-to-unpublish-changes": "Listo para despublicar",
  "app.utils.refresh": "Refrescar",
  ...
  "components.Blocks.blocks.code": "Bloque de código",
  "components.Blocks.blocks.code.languageLabel": "Selecciona un idioma",
  ...
  "components.Blocks.blocks.quote": "Citación",
  "components.Blocks.blocks.selectBlock": "Seleccionar un bloque",
  "components.Blocks.blocks.text": "Texto",
  "components.Blocks.blocks.unorderedList": "Lista con viñetas",
  "components.Blocks.collapse": "Contraer",
  "components.Blocks.dnd.instruction": "Para reordenar los bloques, pulsa Comando o Control junto con Mayúsculas y las teclas de flecha arriba o abajo",
  "components.Blocks.dnd.reorder": "{item}, se ha movido. Nueva posición en el editor: {position}.",
  "components.Blocks.expand": "Expandir",
  "components.Blocks.link": "Enlace",
  "components.Blocks.modifiers.bold": "Negrita",
  "components.Blocks.modifiers.code": "Código en línea",
  "components.Blocks.modifiers.italic": "Cursiva",
  "components.Blocks.modifiers.strikethrough": "Tachado",
  "components.Blocks.modifiers.underline": "Subrayado",
  "components.Blocks.popover.edit": "Editar",
  "components.Blocks.popover.link": "Enlace",
  "components.Blocks.popover.link.error": "Por favor introduce un enlace válido",
  "components.Blocks.popover.link.placeholder": "Pegar enlace",
  "components.Blocks.popover.remove": "Eliminar",
  "components.Blocks.popover.text": "Texto",
  "components.Blocks.popover.text.placeholder": "Añade texto de enlace",
  ...
  "components.Input.error.validation.email.withField": "{field} es un email inválido.",
  "components.Input.error.validation.json": "Esto no coincide con el formato JSON",
  "components.Input.error.validation.json.withField": "{field} no coincide con el formato JSON.",
  "components.Input.error.validation.lowercase": "El valor debe ser una cadena en minúsculas",
  "components.Input.error.validation.lowercase.withField": "{field} tiene que ser una string en minúsculas.",
  "components.Input.error.validation.max": "El valor es demasiado alto {max}.",
  "components.Input.error.validation.max.withField": "{field} es demasiado alto.",
  "components.Input.error.validation.maxLength": "El valor es demasiado largo {max}.",
  "components.Input.error.validation.maxLength.withField": "{field} es demasiado largo.",
  "components.Input.error.validation.min": "El valor es demasiado bajo {min}.",
  "components.Input.error.validation.min.withField": "{field} es demasiado bajo.",
  "components.Input.error.validation.minLength": "El valor es demasiado corto {min}.",
  "components.Input.error.validation.minLength.withField": "{field} es demasiado corto.",
  "components.Input.error.validation.minSupMax": "No puede ser superior",
  "components.Input.error.validation.minSupMax.withField": "{field} no puede ser superior.",
  "components.Input.error.validation.regex": "El valor no coincide con el de regex.",
  "components.Input.error.validation.regex.withField": "{field} no coincide con el regex.",
  "components.Input.error.validation.required": "Este valor es obligatorio.",
  "components.Input.error.validation.required.withField": "{field} es requerido.",
  "components.Input.error.validation.string": "No es una string válida.",
  "components.Input.error.validation.unique": "Este valor ya se utiliza.",
  "components.Input.error.validation.unique.withField": "{field} ya está en uso.",
  ...
  "components.ViewSettings.tooltip": "Ver ajustes",
  ...
  "content-manager.apiError.This attribute must be unique": "{field} debe ser único",
  dark,
  "form.button.continue": "Continue",
  "form.button.done": "Hecho",
  "global.actions": "Acciones",
  "global.active": "Activo",
  "global.auditLogs": "Registros de auditoría",
  "global.back": "Volver",
  ...
  "notification.ee.warning.over-.message": "Añade asientos a {licenseLimitStatus, select, OVER_LIMIT {invite} AT_LIMIT {re-enable}} Usuarios. Si ya lo hiciste pero no lo ves reflejado en tu Strapi, asegúrate de reiniciar tu aplicación.",
  "notification.error": "Se ha producido un error",
  "notification.error.invalid.configuration": "Tienes una configuración inválida, compruebe el registro del servidor para más información.",
  "notification.error.layout": "No se pudo recuperar el esquema",
  "notification.error.tokennamenotunique": "Nombre ya asignado a otro token",
  ...
  "notification.success.apitokencreated": "Token API creado correctamente",
  "notification.success.apitokenedited": "Token API editado correctamente",
  ...
  "notification.success.transfertokencreated": "Token de transferencia creado correctamente",
  "notification.success.transfertokenedited": "Token de transferencia editado correctamente",
...
//# sourceMappingURL=es.json-DRUMGUCV.js.map
