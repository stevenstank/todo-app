...
// node_modules/@strapi/admin/dist/admin/admin/src/translations/fr.json.mjs
...
var fr = {
  ...
  "HomePage.header.subtitle": "Bienvenue sur votre panneau d'administration",
  "HomePage.widget.loading": "Chargement du contenu du widget",
  "HomePage.widget.error": "Impossible de charger le contenu du widget.",
  "HomePage.widget.no-data": "Aucun contenu trouvé.",
  ...
  "Settings.permissions.auditLogs.details": "Détails du log",
  "Settings.permissions.auditLogs.listview.header.subtitle": "Log de toutes les activités qui se sont produites dans votre environnement",
  "Settings.permissions.auditLogs.payload": "Payload",
  "Settings.permissions.auditLogs.user": "Utilisateur",
  "Settings.permissions.auditLogs.userId": "ID Utilisateur",
  "Settings.permissions.users.sso.provider.error": "Une erreur s'est produite lors de la demande des paramètres SSO",
  "Settings.permissions.users.roles": "Rôles",
  "Settings.permissions.users.user-status": "Statut de l'utilisateur",
  "Settings.permissions.users.username": "Nom d'utilisateur",
  "Settings.profile.form.section.experience.mode.hint": "Affiche votre interface dans le mode choisi.",
  "Settings.profile.form.section.experience.mode.label": "Mode d'interface",
  "Settings.profile.form.section.experience.mode.option-label": "Mode {name}",
  "Settings.profile.form.section.experience.mode.option-system-label": "Utiliser les paramètres du système",
  "Settings.sso.form.localAuthenticationLock.label": "Verrouillage de l'authentification locale",
  "Settings.sso.form.localAuthenticationLock.description": "Sélectionnez les rôles pour lesquels vous souhaitez désactiver l'authentification locale.",
  "Settings.content-history.title": "Historique du contenu",
  "Settings.webhooks.event.select": "Sélectionner un événement",
  "Settings.webhooks.events.delete": "Supprimer le webhook",
  "Settings.webhooks.list.loading.success": "Les webhooks ont été chargés",
  "Settings.webhooks.validation.name.required": "Le nom est obligatoire",
  "Settings.webhooks.validation.name.regex": "Le nom doit commencer par une lettre et ne doit contenir que des lettres, des chiffres, des espaces et des underscores.",
  "Settings.webhooks.validation.url.required": "L'url est obligatoire",
  "Settings.webhooks.validation.url.regex": "La valeur doit être une URL valide",
  "Settings.webhooks.validation.key": "La clé est obligatoire",
  "Settings.webhooks.validation.value": "La valeur est obligatoire",
  "Settings.page.PurchaseAudit-logs.description": "Suivez et examinez les changement avec votre équipe",
  "Settings.page.PurchaseAudit-logs.perks1": "Suivez facilement les modifications",
  "Settings.page.PurchaseAudit-logs.perks2": "Examinez simplement les modifications",
  "Usecase.back-end": "Développeur back-end",
  "Usecase.button.skip": "Passer cette question",
  "Usecase.content-creator": "Créateur de contenu",
  "Usecase.front-end": "Développeur front-end",
  "Usecase.input.work-type": "Quel type de travail faites-vous ?",
  "Usecase.notification.success.project-created": "Le projet a été créé avec succès",
  "Usecase.other": "Autre",
  "Usecase.title": "Parlez-nous un peu de vous",
  "admin.pages.MarketPlacePage.sort.label": "Trier par",
  "admin.pages.MarketPlacePage.filters.categories": "Catégories",
  "admin.pages.MarketPlacePage.missingPlugin.description": "Dites-nous quel plugin vous recherchez et nous le ferons savoir à notre communauté de développeurs de plugins au cas où ils seraient en quête d'inspiration !",
  "admin.pages.MarketPlacePage.missingPlugin.title": "Il manque un plugin ?",
  "admin.pages.MarketPlacePage.offline.subtitle": "Vous devez être connecté à internet pour accéder à Strapi Market.",
  "admin.pages.MarketPlacePage.offline.title": "Vous êtes hors ligne",
  "admin.pages.MarketPlacePage.plugin.copy": "Copier la commande d'installation",
  "admin.pages.MarketPlacePage.plugin.copy.success": "Commande d'installation prête à être collée dans votre terminal",
  "admin.pages.MarketPlacePage.plugin.info": "En savoir plus",
  "admin.pages.MarketPlacePage.plugin.info.label": "En savoir plus sur {pluginName}",
  "admin.pages.MarketPlacePage.plugin.info.text": "Plus",
  "admin.pages.MarketPlacePage.plugin.installed": "Installé",
  "admin.pages.MarketPlacePage.plugin.tooltip.verified": "Plugin vérifié par Strapi",
  "admin.pages.MarketPlacePage.plugin.version": 'Mettez à jour votre version de Strapi : "{strapiAppVersion}" à : "{versionRange}"',
  "admin.pages.MarketPlacePage.providers": "Fournisseurs",
  "admin.pages.MarketPlacePage.search.clear": "Effacer la recherche",
  "admin.pages.MarketPlacePage.search.empty": 'Aucun résultat pour "{target}"',
  "admin.pages.MarketPlacePage.search.placeholder": "Recherche",
  "admin.pages.MarketPlacePage.sort.alphabetical": "Ordre alphabétique",
  "admin.pages.MarketPlacePage.sort.alphabetical.selected": "Trier par ordre alphabétique",
  "admin.pages.MarketPlacePage.sort.githubStars": "Nombre d'étoiles GitHub",
  "admin.pages.MarketPlacePage.sort.githubStars.selected": "Trier par étoiles GitHub",
  "admin.pages.MarketPlacePage.sort.newest": "Le plus récent",
  "admin.pages.MarketPlacePage.sort.newest.selected": "Trier par le plus récent",
  "admin.pages.MarketPlacePage.sort.npmDownloads": "Nombre de téléchargements",
  "admin.pages.MarketPlacePage.sort.npmDownloads.selected": "Trier par téléchargements npm",
  "admin.pages.MarketPlacePage.tab-group.label": "Plugins et fournisseurs pour Strapi",
  "app.component.table.read": "Lire {target}",
  "app.component.table.view": "Détails de {target}",
  "app.components.GuidedTour.CM.create.content": "<p>Créer et gérer tout le contenu ici dans le gestionnaire de contenu.</p><p>Ex : En poussant plus loin l'exemple du site Web de blog, on peut écrire un article, le sauvegarder et le publier comme on le souhaite.</p><p>💡 Conseil rapide - N'oubliez pas d'appuyer sur publier sur le contenu que vous créez.</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ Créer du contenu",
  "app.components.GuidedTour.CM.success.content": "<p>Génial, il ne reste plus qu'une étape à franchir !</p><b>🚀 Voir le contenu en action</b>",
  "app.components.GuidedTour.CM.success.cta.title": "Tester l'API",
  "app.components.GuidedTour.CM.success.title": 'Étape 2 : Complétée ✅"',
  "app.components.GuidedTour.CTB.create.content": "<p>Les types de collection vous aident à gérer plusieurs entrées, les types uniques sont adaptés à la gestion d'une seule entrée.</p> <p>Ex : pour un site Web de blog, les articles seraient un type de collection tandis que la page d'accueil serait un type unique.</p>",
  "app.components.GuidedTour.CTB.create.cta.title": "Construire un type de collection",
  "app.components.GuidedTour.CTB.create.title": "🧠 Créer un premier type de collection",
  "app.components.GuidedTour.CTB.success.content": "<p>Bien joué !</p> <b>⚡️ Qu'aimeriez-vous partager avec le monde entier ?</b>",
  "app.components.GuidedTour.CTB.success.title": 'Étape 1 : Complétée ✅"',
  "app.components.GuidedTour.apiTokens.create.content": "<p>Générez un jeton d'authentification ici et récupérez le contenu que vous venez de créer.</p>",
  "app.components.GuidedTour.apiTokens.create.cta.title": "Générer un token API",
  "app.components.GuidedTour.apiTokens.create.title": "🚀 Voir le contenu en action",
  "app.components.GuidedTour.apiTokens.success.title": 'Étape 3 : Terminée ✅"',
  "app.components.GuidedTour.create-content": "Créer du contenu",
  "app.components.GuidedTour.home.CM.title": "⚡️ Qu'aimeriez-vous partager avec le monde ?",
  "app.components.GuidedTour.home.CTB.cta.title": "Aller dans le constructeur de type de contenu",
  "app.components.GuidedTour.home.CTB.title": "🧠 Construire la structure du contenu",
  "app.components.GuidedTour.home.apiTokens.cta.title": "Tester l'API",
  "app.components.GuidedTour.skip": "Passer la visite",
  "app.components.GuidedTour.title": "3 étapes pour démarrer",
  "app.components.LeftMenu.logo.alt": "Logo de l'application",
  "Usecase.full-stack": "Développeur full-stack",
  "app.components.LeftMenu.navbrand.title": "Tableau de bord Strapi",
  "app.components.LeftMenu.navbrand.workplace": "Lieu de travail",
  "app.components.NpsSurvey.banner-title": "Quelle est la probabilité que vous recommandiez Strapi à un ami ou à un collègue ?",
  "app.components.NpsSurvey.feedback-response": "Merci beaucoup pour votre retour !",
  "app.components.NpsSurvey.feedback-question": "Avez-vous des suggestions d'amélioration ?",
  "app.components.NpsSurvey.submit-feedback": "Envoyer un retour",
  "app.components.NpsSurvey.dismiss-survey-label": "Fermer le sondage",
  "app.components.NpsSurvey.no-recommendation": "Peu probable",
  "app.components.NpsSurvey.happy-to-recommend": "Extrêmement probable",
  "app.page.not.found": "Oups ! Nous n'arrivons pas à trouver la page que vous cherchez...",
  "app.utils.refresh": "Rafraîchir",
  "app.utils.ready-to-publish-changes": "Prêt à publier les modifications",
  "app.utils.ready-to-unpublish-changes": "Prêt à dépublier",
  "app.confirm.body": "Voulez-vous continuer ?",
  "components.Input.error.contain.maxBytes": "Le mot de passe doit être inférieur à 73 octets",
  "components.Input.error.validation.lowercase": "La valeur doit être une chaîne de caractères minuscules",
  "components.Input.error.validation.string": "Il ne s'agit pas d'une chaîne de caractères valide.",
  "components.ViewSettings.tooltip": "Afficher les paramètres",
  "components.Blocks.blocks.selectBlock": "Sélectionner un bloc",
  "components.Blocks.blocks.code.languageLabel": "Sélectionner une langue",
  "components.Blocks.dnd.instruction": "Pour réorganiser les blocs, appuyez sur Commande ou Contrôle ainsi que sur Maj et sur les touches Flèche Haut et Flèche Bas",
  "global.close": "Fermer",
  "global.home": "Accueil",
...
//# sourceMappingURL=fr.json-AXVO6QII.js.map
