...
// node_modules/@strapi/admin/dist/admin/admin/src/translations/pl.json.mjs
...
var noPreview = "Podgląd nie jest dostępny";
var clearLabel = "Wyczyść";
var dark = "Ciemny";
var light = "Jasny";
var or = "LUB";
var selectButtonTitle = "Wybierz";
...
var pl = {
  ...
  "Auth.form.active.label": "Aktywne",
  ...
  "HomePage.addWidget.button": "Dodaj widget",
  "HomePage.addWidget.noWidgetsAvailable": "Brak dostępnych widgetów do dodania",
  "HomePage.addWidget.title": "Dodaj widget",
  "HomePage.head.title": "Strona główna",
  "HomePage.header.title": "Cześć {name}",
  "HomePage.header.subtitle": "Witaj w Twoim panelu administracyjnym",
  "HomePage.widget.delete": "Usuń",
  "HomePage.widget.drag": "Przeciągnij, aby przesunąć",
  "HomePage.widget.loading": "Ładowanie treści widgetu",
  "HomePage.widget.error": "Nie można załadować treści widgetu.",
  "HomePage.widget.no-data": "Nie znaleziono treści.",
  "HomePage.widget.no-permissions": "Nie masz uprawnień do wyświetlania tego widgetu",
  ...
  "Settings.apiTokens.ListView.headers.createdAt": "Utworzono",
  "Settings.apiTokens.ListView.headers.description": "Opis",
  "Settings.apiTokens.ListView.headers.lastUsedAt": "Data ostatniego użycia",
  "Settings.apiTokens.ListView.headers.name": "Nazwa",
  ...
  "Settings.apiTokens.copy.lastWarning": "Skopiuj swój API Token",
  "Settings.apiTokens.create": "Stwórz nowy API Token",
  "Settings.apiTokens.createPage.BoundRoute.title": "Ścieżka przypisana do",
  "Settings.apiTokens.createPage.permissions.description": "Tylko akcje przypisane do ścieżek są pokazane poniżej.",
  "Settings.apiTokens.createPage.permissions.header.hint": "Wybierz akcję aplikacji lub plugin i kliknij ikonę koła zębatego, aby wyświetlić powiązaną ścieżkę",
  "Settings.apiTokens.createPage.permissions.header.title": "Ustawienia zaawansowane",
  "Settings.apiTokens.createPage.permissions.title": "Uprawnienia",
  "Settings.apiTokens.createPage.title": "Stwórz API Token",
  ...
  "Settings.apiTokens.regenerate": "Regeneruj",
  "Settings.apiTokens.title": "API Tokeny",
  "Settings.apiTokens.lastHour": "ostatnia godzina",
  "Settings.application.customization": "Personalizacja",
  "Settings.application.customization.auth-logo.carousel-hint": "Zmień logo na stronach uwierzytelniania",
  "Settings.application.customization.carousel-hint": "Zmień logo panelu admina (maksymalny rozmiar: {dimension}x{dimension}, maksymalny rozmiar pliku: {size}KB)",
  "Settings.application.customization.carousel-slide.label": "Slajd logo",
  "Settings.application.customization.carousel.auth-logo.title": "Logo na stronach uwierzytelnienia",
  "Settings.application.customization.carousel.change-action": "Zmień logo",
  "Settings.application.customization.carousel.menu-logo.title": "Logo w Menu",
  "Settings.application.customization.carousel.reset-action": "Resetuj logo",
  "Settings.application.customization.carousel.title": "Logo",
  "Settings.application.customization.menu-logo.carousel-hint": "Zmień logo w menu głównym",
  "Settings.application.customization.modal.cancel": "Anuluj",
  "Settings.application.customization.modal.pending": "Oczekujące logo",
  "Settings.application.customization.modal.pending.card-badge": "obraz",
  "Settings.application.customization.modal.pending.choose-another": "Wybierz inne logo",
  "Settings.application.customization.modal.pending.subtitle": "Zarządzaj wybranym logo przed jego przesłaniem",
  "Settings.application.customization.modal.pending.title": "Logo gotowe do przesłania",
  "Settings.application.customization.modal.pending.upload": "Prześlij logo",
  "Settings.application.customization.modal.tab.label": "W jaki sposób chcesz przesłać swoje zasoby?",
  "Settings.application.customization.modal.upload": "Prześlij logo",
  "Settings.application.customization.modal.upload.cta.browse": "Przeglądaj pliki",
  "Settings.application.customization.modal.upload.drag-drop": "Przeciągnij i upuść tutaj, lub",
  "Settings.application.customization.modal.upload.error-format": "Przesłano niewłaściwy format (akceptowane formaty: jpeg, jpg, png, svg).",
  "Settings.application.customization.modal.upload.error-network": "Błąd sieci",
  "Settings.application.customization.modal.upload.error-size": "Przesłany plik jest za duży (maksymalny rozmiar: {dimension}x{dimension}, maksymalny rozmiar pliku: {size}KB)",
  "Settings.application.customization.modal.upload.file-validation": "Maksymalny rozmiar: {dimension}x{dimension}, Maksymalny rozmiar pliku: {size}KB",
  "Settings.application.customization.modal.upload.from-computer": "Z komputera",
  "Settings.application.customization.modal.upload.from-url": "Z adresu URL",
  "Settings.application.customization.modal.upload.from-url.input-label": "URL",
  "Settings.application.customization.modal.upload.next": "Dalej",
  "Settings.application.customization.size-details": "Maksymalny rozmiar: {dimension}×{dimension}, Maksymalny rozmiar pliku: {size}KB",
  ...
  "Settings.tokens.RegenerateDialog.title": "Regeneruj token",
  ...
  "Settings.tokens.duration.30-days": "30 dni",
  "Settings.tokens.duration.7-days": "7 dni",
  "Settings.tokens.duration.90-days": "90 dni",
  "Settings.tokens.duration.expiration-date": "Data wygaśnięcia",
  "Settings.tokens.duration.unlimited": "Bez limitu",
  "Settings.tokens.form.description": "Opis",
  "Settings.tokens.form.duration": "Czas ważności tokenu",
  "Settings.tokens.form.name": "Nazwa",
  "Settings.tokens.form.type": "Typ tokenu",
  "Settings.tokens.notification.copied": "Token skopiowany do schowka",
  "Settings.tokens.popUpWarning.message": "Czy na pewno chcesz ponownie wygenerować ten token?",
  "Settings.tokens.regenerate": "Regeneruj",
  "Settings.tokens.types.custom": "Inny",
  "Settings.tokens.types.full-access": "Pełen dostęp",
  "Settings.tokens.types.read-only": "Tylko do odczytu",
  "Settings.transferTokens.ListView.headers.type": "Typ tokenu",
  "Settings.transferTokens.addFirstToken": "Dodaj swój pierwszy Transfer Token",
  "Settings.transferTokens.addNewToken": "Dodaj nowy Transfer Token",
  "Settings.transferTokens.create": "Stwórz nowy Transfer Token",
  "Settings.transferTokens.createPage.title": "Stwórz Transfer Token",
  "Settings.transferTokens.description": "Lista wygenerowanych transfer tokenów",
  "Settings.transferTokens.emptyStateLayout": "Nie masz jeszcze żadnej treści...",
  "Settings.transferTokens.title": "Transfer Tokeny",
  "Settings.error": "Błąd",
  "Settings.global": "Ustawienia Globalne",
  "Settings.permissions": "Panel administracyjny",
  "Settings.permissions.auditLogs.action": "Akcja",
  "Settings.permissions.auditLogs.admin.auth.success": "Zalogowanie administratora",
  "Settings.permissions.auditLogs.admin.logout": "Wylogowanie administratora",
  "Settings.permissions.auditLogs.component.create": "Stwórz komponent",
  "Settings.permissions.auditLogs.component.delete": "Usuń komponent",
  "Settings.permissions.auditLogs.component.update": "Edytuj komponent",
  "Settings.permissions.auditLogs.content-type.create": "Stwórz typ treści",
  "Settings.permissions.auditLogs.content-type.delete": "Usuń typ treści",
  "Settings.permissions.auditLogs.content-type.update": "Edytuj typ treści",
  "Settings.permissions.auditLogs.date": "Data",
  "Settings.permissions.auditLogs.details": "Szczegóły logu",
  "Settings.permissions.auditLogs.entry.create": "Stwórz wpis{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.entry.delete": "Usuń wpis{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.entry.publish": "Opublikuj wpis {model, select, undefined {} other {({model})}}",
  "Settings.permissions.auditLogs.entry.unpublish": "Cofnij publikację wpis{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.entry.update": "Edytuj wpis{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.filters.combobox.aria-label": "Wyszukaj i wybierz opcję filtrowania",
  "Settings.permissions.auditLogs.listview.header.subtitle": "Dziennik wszystkich zdarzeń, które miały miejsce w Twoim środowisku",
  "Settings.permissions.auditLogs.not-available": "Dziennik zdarzeń jest dostępny tylko jako część płatnego planu. Uaktualnij, aby uzyskać wyszukiwalny i filtrowalny widok wszystkich działań.",
  "Settings.permissions.auditLogs.media.create": "Stwórz media",
  "Settings.permissions.auditLogs.media.delete": "Usuń media",
  "Settings.permissions.auditLogs.media.update": "Edytuj media",
  "Settings.permissions.auditLogs.payload": "Payload",
  "Settings.permissions.auditLogs.permission.create": "Stwórz uprawnienie",
  "Settings.permissions.auditLogs.permission.delete": "Usuń uprawnienie",
  "Settings.permissions.auditLogs.permission.update": "Edytuj uprawnienie",
  "Settings.permissions.auditLogs.role.create": "Stwórz rolę",
  "Settings.permissions.auditLogs.role.delete": "Usuń rolę",
  "Settings.permissions.auditLogs.role.update": "Edytuj rolę",
  "Settings.permissions.auditLogs.user": "Użytkownik",
  "Settings.permissions.auditLogs.user.create": "Stwórz użytkownika",
  "Settings.permissions.auditLogs.user.delete": "Usuń użytkownika",
  "Settings.permissions.auditLogs.user.fullname": "{firstname} {lastname}",
  "Settings.permissions.auditLogs.user.update": "Edytuj użytkownika",
  "Settings.permissions.auditLogs.userId": "ID użytkownika",
  ...
  "Settings.permissions.conditions.conditions": "Definiowanie warunków",
  "Settings.permissions.conditions.define-conditions": "Zdefiniuj warunki",
  ...
  "Settings.permissions.users.active": "Aktywny",
  ...
  "Settings.permissions.users.inactive": "Nieaktywny",
  "Settings.permissions.users.lastname": "Nazwisko",
  "Settings.permissions.users.form.sso": "Połącz z logowaniem jednokrotnym (SSO)",
  "Settings.permissions.users.sso.provider.error": "Wystąpił błąd podczas pobierania ustawień SSO",
  ...
  "Settings.permissions.users.strapi-editor": "Edytor",
  "Settings.permissions.users.strapi-super-admin": "Super Admin",
  "Settings.permissions.users.tabs.label": "Uprawnienia",
  "Settings.permissions.users.user-status": "Status użytkownika",
  "Settings.permissions.users.username": "Nazwa użytkownika",
  ...
  "Settings.profile.form.section.experience.mode.option-system-label": "Użyj ustawień systemowych",
  ...
  "Settings.sso.form.localAuthenticationLock.label": "Lokalna blokada uwierzytelniania",
  "Settings.sso.form.localAuthenticationLock.description": "Wybierz role, dla których chcesz wyłączyć uwierzytelnianie lokalne",
  ...
  "Settings.sso.not-available": "SSO jest dostępne tylko jako część płatnego planu. Uaktualnij, aby skonfigurować dodatkowe metody logowania i rejestracji dla swojego panelu administracyjnego.",
  "Settings.content-history.title": "Historia treści",
  "Settings.content-history.description": "Uzyskaj większą kontrolę nad każdym etapem cyklu życia swoich treści.",
  "Settings.content-history.not-available": "Historia treści jest dostępna tylko jako część płatnego planu. Uaktualnij, aby uzyskać pełną kontrolę nad cyklem życia treści.",
  "Settings.tokens.Button.cancel": "Anuluj",
  "Settings.tokens.Button.regenerate": "Regeneruj",
  "Settings.tokens.ListView.headers.createdAt": "Utworzono",
  "Settings.tokens.ListView.headers.description": "Opis",
  "Settings.tokens.ListView.headers.lastUsedAt": "Data ostatniego użycia",
  "Settings.tokens.ListView.headers.name": "Nazwa",
  ...
  "Settings.webhooks.event.select": "Wybierz zdarzenie",
  "Settings.webhooks.events.isLoading": "Ładowanie zdarzeń",
  "Settings.webhooks.events.create": "Utwórz",
  "Settings.webhooks.events.update": "Edytuj",
  "Settings.webhooks.events.delete": "Usuń webhook",
  ...
  "Settings.webhooks.list.loading.success": "Webhooki zostały załadowane",
  ...
  "Settings.webhooks.validation.name.required": "Nazwa jest wymagana",
  "Settings.webhooks.validation.name.regex": "Nazwa musi zaczynać się od litery i zawierać wyłącznie litery, cyfry, spacje i znaki podkreślenia",
  "Settings.webhooks.validation.url.required": "URL jest wymagany",
  "Settings.webhooks.validation.url.regex": "Wartość musi być poprawnym adresem URL",
  "Settings.webhooks.validation.key": "Klucz jest wymagany",
  "Settings.webhooks.validation.value": "Wartość jest wymagana",
  "Settings.page.PurchaseAudit-logs.description": "Śledź i przeglądaj zmiany ze swoim zespołem",
  "Settings.page.PurchaseAudit-logs.perks1": "Łatwo śledź zmiany",
  "Settings.page.PurchaseAudit-logs.perks2": "Przeglądaj zmiany z łatwością",
  "Settings.page.PurchaseAudit-logs.perks3": "Utrzymuj bezpieczeństwo i zgodność",
  "Settings.page.PurchaseContent-history.description": "Natychmiastowo wycofuj zmiany treści",
  "Settings.page.PurchaseContent-history.perks1": "Przeglądaj swoją historię treści",
  "Settings.page.PurchaseContent-history.perks2": "Cofaj zmiany jednym kliknięciem",
  "Settings.page.PurchaseContent-history.perks3": "Śledź zmiany w różnych językach",
  "Settings.page.PurchaseSSO.description": "Uprość uwierzytelnianie dla swojego zespołu",
  "Settings.page.PurchaseSSO.perks1": "Ujednolicone uwierzytelnianie",
  "Settings.page.PurchaseSSO.perks2": "Zwiększone bezpieczeństwo",
  "Settings.page.PurchaseSSO.perks3": "Wsparcie dla webhooków",
  "Settings.page.purchase.upgrade.cta": "Zaktualizuj",
  "Settings.page.purchase.learn-more.cta": "Dowiedz się więcej",
  ...
  "app.component.table.read": "Czytaj {target}",
  "app.component.table.select.one-entry": "Wybierz {target}",
  "app.component.table.view": "Szczegóły {target}",
  ...
  "app.components.BlockLink.cloud.content": "W pełni zarządzany hosting w chmurze dla Twojego projektu Strapi.",
  ...
  "app.components.FreeTrialEndedModal.button.downgrade": "Obniż do edycji Community",
  "app.components.FreeTrialEndedModal.button.upgrade": "Pozostań na obecnym planie",
  "app.components.FreeTrialEndedModal.description": "Dostęp do funkcji takich jak Historia treści, Wydania oraz Ujednolicone uwierzytelnianie (SSO) wygasł.",
  "app.components.FreeTrialEndedModal.notice.item1": "Obniżenie wersji spowoduje utratę dostępu do powyższych funkcji.",
  "app.components.FreeTrialEndedModal.notice.item2": "Historia wersji zostanie usunięta.",
  "app.components.FreeTrialEndedModal.notice.item3": "Wszystkie wydania zostaną usunięte.",
  "app.components.FreeTrialEndedModal.notice.item4": "Jeśli zdecydujesz się na obniżenie wersji, pamiętaj o ustawieniu hasła super admina, aby zachować dostęp do panelu administracyjnego.",
  "app.components.FreeTrialEndedModal.notice.title": "Ważne, aby wiedzieć:",
  "app.components.FreeTrialEndedModal.title": "Twój okres próbny dobiegł końca",
  "app.components.FreeTrialWelcomeModal.button": "Zacznij eksplorować",
  "app.components.FreeTrialWelcomeModal.description1": "Przez następne 30 dni będziesz mieć pełny dostęp do zaawansowanych funkcji, takich jak Historia treści, Wydania i Jednokrotne Logowanie (SSO) – wszystko, czego potrzebujesz, aby odkryć możliwości Strapi CMS.",
  "app.components.FreeTrialWelcomeModal.description2": "Wykorzystaj ten czas na tworzenie, dostosowywanie i testowanie przepływów pracy nad treścią z pełną elastycznością!",
  "app.components.FreeTrialWelcomeModal.title": "Cieszymy się, że jesteś z nami na pokładzie",
  ...
  "app.components.LeftMenu.logo.alt": "Logo aplikacji",
  ...
  "app.components.LeftMenu.trialCountdown.endedAt": "Twój okres próbny skończył się {date}.",
  "app.components.LeftMenu.trialCountdown.endsAt": "Twój okres próbny skończy się {date}.",
  ...
  "app.components.NpsSurvey.banner-title": "Jak prawdopodobne jest, że poleciłbyś Strapi znajomemu lub współpracownikowi?",
  "app.components.NpsSurvey.feedback-response": "Dziękujemy za Twoją opinię!",
  "app.components.NpsSurvey.feedback-question": "Czy masz jakieś sugestie dotyczące ulepszeń?",
  "app.components.NpsSurvey.submit-feedback": "Wyślij opinię",
  "app.components.NpsSurvey.dismiss-survey-label": "Odrzuć ankietę",
  "app.components.NpsSurvey.no-recommendation": "Wcale nieprawdopodobne",
  "app.components.NpsSurvey.happy-to-recommend": "Bardzo prawdopodobne",
  "app.components.NpsSurvey.select-rating": "Wybierz ocenę",
  ...
  "app.components.Onboarding.link.build-content": "Zbuduj architekturę treści",
  "app.components.Onboarding.link.manage-content": "Dodaj treść i zarządzaj nią",
  "app.components.Onboarding.link.manage-media": "Zarządzaj mediami",
  "app.components.Onboarding.link.more-videos": "Oglądnij więcej wideo",
  ...
  "app.components.ToggleCheckbox.enabled-label": "Włączone",
  "app.components.ToggleCheckbox.disabled-label": "Wyłączone",
  "app.components.UpsellBanner.button": "Zaktualizuj teraz",
  "app.components.UpsellBanner.intro": "Dostęp do funkcji planu Wzrost:",
  "app.components.UpsellBanner.text": "W ramach okresu próbnego możesz zapoznać się z narzędziami premium, takimi jak Historia treści, Wydania i Jednokrotne logowanie (SSO).",
  ...
  "app.utils.update-filter": "Aktualizuj filtr",
  ...
  "app.utils.published": "Opublikowano",
  "app.utils.ready-to-publish": "Gotowe do publikacji",
  "app.utils.already-published": "Już opublikowane",
  "app.utils.ready-to-publish-changes": "Gotowe do opublikowania zmian",
  "app.utils.ready-to-unpublish-changes": "Gotowe do cofnięcia publikacji",
  "app.confirm.body": "Czy na pewno?",
  clearLabel,
  ...
  "components.Input.error.contain.maxBytes": "Hasło musi być mniejsze niż 73 bajty",
  ...
  "components.Input.error.validation.combobox.invalid": "Wartość nie jest prawidłowa",
  ...
  "components.Input.error.validation.string": "Wartość nie jest poprawnym ciągiem znaków.",
  ...
  "components.Input.error.validation.email.withField": "{field} jest nieprawidłowym adresem email",
  "components.Input.error.validation.json.withField": "{field} nie pasuje do formatu JSON",
  "components.Input.error.validation.lowercase.withField": "{field} musi być zapisane małymi literami",
  "components.Input.error.validation.max.withField": "{field} ma za wysoką wartość.",
  "components.Input.error.validation.maxLength.withField": "{field} jest za długie.",
  "components.Input.error.validation.min.withField": "{field} ma za niską wartość.",
  "components.Input.error.validation.minLength.withField": "{field} jest za krótkie.",
  "components.Input.error.validation.minSupMax.withField": "{field} nie może być większe",
  "components.Input.error.validation.regex.withField": "{field} nie pasuje do wyrażenia regularnego.",
  "components.Input.error.validation.required.withField": "{field} jest wymagane.",
  "components.Input.error.validation.unique.withField": "{field} jest już używane.",
  ...
  "components.ViewSettings.tooltip": "Zobacz ustawienia",
  "components.TableHeader.sort": "Sortuj {label}",
  "components.Blocks.modifiers.bold": "Pogrubienie",
  "components.Blocks.modifiers.italic": "Pochylenie",
  "components.Blocks.modifiers.underline": "Podkreślenie",
  "components.Blocks.modifiers.strikethrough": "Przekreślenie",
  "components.Blocks.modifiers.code": "Kod w linii",
  "components.Blocks.link": "Link",
  "components.Blocks.expand": "Rozwiń",
  "components.Blocks.collapse": "Zwiń",
  "components.Blocks.popover.text": "Tekst",
  "components.Blocks.popover.text.placeholder": "Wprowadź tekst linku",
  "components.Blocks.popover.link": "Link",
  "components.Blocks.popover.link.placeholder": "Wklej link",
  "components.Blocks.popover.link.rel": "Rel (opcjonalne)",
  "components.Blocks.popover.link.rel.placeholder": "noopener, nofollow, noreferrer",
  "components.Blocks.popover.link.target": "Target (opcjonalne)",
  "components.Blocks.popover.link.target.placeholder": "_blank, _self, _parent, _top",
  "components.Blocks.popover.link.error": "Proszę wpisz prawidłowy link",
  "components.Blocks.popover.remove": "Usuń",
  "components.Blocks.popover.edit": "Edytuj",
  "components.Blocks.blocks.selectBlock": "Wybierz blok",
  "components.Blocks.blocks.text": "Tekst",
  "components.Blocks.blocks.heading1": "Nagłówek H1",
  "components.Blocks.blocks.heading2": "Nagłówek H2",
  "components.Blocks.blocks.heading3": "Nagłówek H3",
  "components.Blocks.blocks.heading4": "Nagłówek H4",
  "components.Blocks.blocks.heading5": "Nagłówek H5",
  "components.Blocks.blocks.heading6": "Nagłówek H6",
  "components.Blocks.blocks.code": "Blok kodu",
  "components.Blocks.blocks.quote": "Cytat",
  "components.Blocks.blocks.image": "Obraz",
  "components.Blocks.blocks.unorderedList": "Lista wypunktowana",
  "components.Blocks.blocks.orderedList": "Lista numerowana",
  "components.Blocks.blocks.code.languageLabel": "Wybierz język",
  "components.Blocks.dnd.instruction": "Aby zmienić kolejność bloków, naciśnij klawisz Command lub Control wraz z klawiszem Shift i strzałkami w górę lub w dół",
  "components.Blocks.dnd.reorder": "{item}, przeniesiony. Nowa pozycja w edytorze: {position}.",
  ...
  "components.Wysiwyg.blocks.code": "Kod",
  "components.Wysiwyg.selectOptions.H1": "Nagłówek H1",
  "components.Wysiwyg.selectOptions.H2": "Nagłówek H2",
  "components.Wysiwyg.selectOptions.H3": "Nagłówek H3",
  "components.Wysiwyg.selectOptions.H4": "Nagłówek H4",
  "components.Wysiwyg.selectOptions.H5": "Nagłówek H5",
  "components.Wysiwyg.selectOptions.H6": "Nagłówek H6",
  ...
  "components.premiumFeature.title": "Funkcja premium",
  dark,
  "form.button.continue": "Dalej",
  "form.button.done": "Gotowe",
  "global.actions": "Akcje",
  "global.auditLogs": "Dziennik zdarzeń",
  "global.back": "Powrót",
  ...
  "global.last-change.redo": "Ponów zmianę",
  "global.last-change.undo": "Cofnij zmianę",
  "global.last-changes.discard": "Odrzuć zmiany",
  ...
  "global.error": "Coś poszło nie tak",
  ...
  "global.plugins.content-manager": "Menedżer Treści",
  "global.plugins.content-manager.description": "Szybki sposób na przeglądanie, edycję i usuwanie danych.",
  "global.plugins.content-type-builder": "Konstruktor typów treści",
  "global.plugins.content-type-builder.description": "Modeluj strukturę danych swojego API. Twórz nowe pola i relacje w ciągu zaledwie minuty. Pliki są automatycznie tworzone i aktualizowane w Twoim projekcie.",
  "global.plugins.documentation": "Dokumentacja",
  "global.plugins.documentation.description": "Stwórz dokument OpenAPI i zwizualizuj twoje API z wykorzystanim SWAGGER UI.",
  "global.plugins.email": "Email",
  "global.plugins.email.description": "Skonfiguruj swoją aplikację do wysyłania wiadomości e-mail.",
  "global.plugins.graphql": "GraphQL",
  "global.plugins.graphql.description": "Dodaje endpoint GraphQL z domyślnymi metodami API.",
  "global.plugins.i18n": "Internacjonalizacja",
  "global.plugins.i18n.description": "Ten plugin umożliwia tworzenie, odczytywanie i aktualizowanie treści w różnych językach, zarówno z poziomu Panelu administracyjnego, jak i za pośrednictwem API.",
  "global.plugins.sentry": "Sentry",
  "global.plugins.sentry.description": "Wysyłaj zdarzenia błędów Strapi do Sentry.",
  "global.plugins.upload": "Biblioteka mediów",
  "global.plugins.upload.description": "Zarządzanie mediami.",
  "global.plugins.users-permissions": "Role i Uprawnienia",
  "global.plugins.users-permissions.description": "Chroń swoje API za pomocą pełnego procesu uwierzytelniania opartego na JWT. Ten plugin zawiera również strategię ACL, która umożliwia zarządzanie uprawnieniami między grupami użytkowników.",
  "global.profile": "Profil",
  "global.profile.settings": "Ustawienia profilu",
  ...
  "global.learn-more": "Dowiedz się więcej",
  "global.localeToggle.label": "Wybierz język interfejsu",
  light,
  "notification.contentType.relations.conflict": "Typ treści ma sprzeczne relacje",
  "notification.default.title": "Informacja:",
  "notification.ee.warning.at-seat-limit.title": "{licenseLimitStatus, select, OVER_LIMIT {ponad} AT_LIMIT {równo z}} limitem miejsc ({currentUserCount}/{permittedSeats})",
  "notification.ee.warning.over-.message": "Dodaj miejsca aby {licenseLimitStatus, select, OVER_LIMIT {zaprosić} AT_LIMIT {reaktywować}} użytkowników. Jeśli już to zrobiłeś, ale nie widać tego jeszcze w Strapi, pamiętaj o ponownym uruchomieniu aplikacji.",
  "notification.error": "Wystąpił błąd",
  "notification.error.invalid.configuration": "Konfiguracja jest nieprawidłowa. Sprawdź logi serwera, aby uzyskać więcej informacji.",
  "notification.error.layout": "Nie udało się pobrać układu",
  "notification.error.tokennamenotunique": "Nazwa już przypisana do innego tokena",
  ...
  "notification.success.apitokencreated": "Pomyślnie utworzono API Token",
  "notification.success.apitokenedited": "Pomyślnie zedytowano API Token",
  ...
  "notification.success.transfertokencreated": "Pomyślnie utworzono Transfer Token",
  "notification.success.transfertokenedited": "Pomyślnie zedytowano Transfer Token",
  "notification.version.update.message": "Dostępna jest nowa wersja Strapi!",
  "notification.warning.404": "404 - nie znaleziono",
  ...
  skipToContent,
  submit,
  "tours.contentTypeBuilder.Introduction.title": "Witamy w konstruktorze typów treści!",
  "tours.contentTypeBuilder.Introduction.content": "Tutaj tworzysz strukturę swojej aplikacji i zarządzasz nią za pomocą typów kolekcji, typów pojedynczych i komponentów wielokrotnego użytku.",
  "tours.contentTypeBuilder.AIChat.title": "Czas zacząć!",
  "tours.contentTypeBuilder.AIChat.content": "<p>Jeśli masz jakiekolwiek pytania dotyczące Konstruktura typów treści lub Strapi, zadaj je tutaj.</p><p>Strapi AI może generować schematy dostosowane do Twoich potrzeb. <ul><li>Selektor dat</li><li>Pola e-mail i hasło</li><li>Media dowolnego typu</li><li>UID</li></ul></p><p>Nie wstydź się, wypróbuj!</p>",
  "tours.contentTypeBuilder.CollectionTypes.title": "Typy kolekcji",
  "tours.contentTypeBuilder.CollectionTypes.content": "To Twój sposób na zarządzanie wieloma wpisami - pomyśl o postach na blogu lub produktach.",
  "tours.contentTypeBuilder.SingleTypes.title": "Typy pojedyncze",
  "tours.contentTypeBuilder.SingleTypes.content": "Idealny do pojedynczych wpisów, takich jak strona główna lub ustawienia witryny.",
  "tours.contentTypeBuilder.Components.title": "Komponenty",
  "tours.contentTypeBuilder.Components.content": "Zbuduj raz, używaj go ponownie wszędzie.",
  "tours.contentTypeBuilder.YourTurn.title": "Twoja kolej — zbuduj coś!",
  "tours.contentTypeBuilder.YourTurn.content": "Śmiało, utwórz typ kolekcji lub typ pojedynczy.",
  "tours.contentTypeBuilder.AddFields.title": "Dodaj pole",
  "tours.contentTypeBuilder.AddFields.content": "Zacznij od dodania pierwszego pola — takiego jak imię i nazwisko, zdjęcie lub relacja.",
  "tours.contentTypeBuilder.Save.title": "Nie wychodź bez zapisywania!",
  "tours.contentTypeBuilder.Save.content": 'Kliknij przycisk "Zapisz", aby zapisać typ treści i uniknąć utraty pracy.',
  "tours.contentTypeBuilder.Finish.title": "Pierwszy krok: gotowe!",
  "tours.contentTypeBuilder.Finish.content": "Stworzyłeś swój pierwszy typ treści!",
  "tours.apiTokens.Introduction.title": "I wreszcie tokeny API",
  "tours.apiTokens.Introduction.content": "Kontroluj dostęp do API za pomocą wysoce konfigurowalnych uprawnień.",
  "tours.apiTokens.ManageAPIToken.title": "Zarządzaj tokenem API",
  "tours.apiTokens.ManageAPIToken.content": 'Kliknij ikonę "Ołówek", aby wyświetlić i zaktualizować istniejący token API.',
  "tours.apiTokens.ViewAPIToken.title": "Wyświetl token API",
  "tours.apiTokens.ViewAPIToken.content": 'Kliknij przycisk "Wyświetl token", aby zobaczyć swój token API.',
  "tours.apiTokens.CopyAPIToken.title": "Skopiuj swój token API",
  "tours.apiTokens.CopyAPIToken.content": 'Kliknij przycisk "Kopiuj", aby zapisać token API. Będziesz go potrzebować do wysyłania żądań do swojej aplikacji. <a>Tokeny API</a>.',
  "tours.apiTokens.FinalStep.title": "Gratulacje, czas wdrożyć aplikację!",
  "tours.apiTokens.FinalStep.content": "Masz wszystko, czego potrzebujesz, aby wdrożyć aplikację i udostępniać treści światu.",
  "tours.contentManager.Introduction.title": "Menedżer treści",
  "tours.contentManager.Introduction.content": "Twórz i zarządzaj treściami z typów kolekcji i typów pojedynczych.",
  "tours.contentManager.CreateNewEntry.title": "Utwórz nowy wpis",
  "tours.contentManager.CreateNewEntry.content": 'Kliknij przycisk "„Utwórz nowy wpis", aby utworzyć i opublikować nowy wpis dla tego typu kolekcji.',
  "tours.contentManager.Fields.title": "Pola",
  "tours.contentManager.Fields.content": "Najpierw wypełnij pola utworzone w Konstruktorze typów treści.",
  "tours.contentManager.Publish.title": "Opublikuj",
  "tours.contentManager.Publish.content": 'Następnie kliknij przycisk "Opublikuj", aby udostępnić treść za pośrednictwem interfejsu API treści.',
  "tours.contentManager.FinalStep.title": "Czas skonfigurować tokeny API!",
  "tours.contentManager.FinalStep.content": "Teraz, gdy już utworzyłeś i opublikowałeś wpis, skonfigurujmy token API, aby zarządzać dostępem do Twoich treści.",
  "tours.skip": "Pomiń",
  "tours.next": "Następny",
  "tours.gotIt": "Rozumiem",
  "tours.overview.title": "Odkryj swoją aplikację!",
  "tours.overview.subtitle": "Skorzystaj z przewodnika, aby jak najlepiej wykorzystać Strapi.",
  "tours.overview.close": "Zamknij przewodnik",
  "tours.overview.tasks": "Twoje zadania",
  "tours.overview.contentTypeBuilder.label": "Stwórz swój schemat",
  "tours.overview.contentManager.label": "Twórz i publikuj treści",
  "tours.overview.apiTokens.label": "Skopiuj token API",
  "tours.overview.strapiCloud.label": "Wdróż swoją aplikację w Strapi Cloud",
  "tours.overview.strapiCloud.link": "Przeczytaj dokumentację",
  "tours.overview.tour.link": "Start",
  "tours.overview.tour.done": "Koniec",
  "tours.overview.close.description": "Czy na pewno chcesz zamknąć przewodnik?",
  "tours.profile.title": "Przewodnik",
  "tours.profile.description": "W każdej chwili możesz zresetować przewodnik.",
  "tours.profile.reset": "Zresetuj przewodnik",
  "tours.profile.notification.success.reset": "Reset przewodnika",
  "tours.overview.completed": "Ukończono {completed}%",
  "tours.stepCount": "Krok {currentStep} z {tourLength}",
  "widget.key-statistics.list.admins": "Administratorzy",
  "widget.key-statistics.list.apiTokens": "Tokeny API",
  "widget.key-statistics.list.assets": "Zasoby",
  "widget.key-statistics.list.components": "Komponenty",
  "widget.key-statistics.list.contentTypes": "Typy treści",
  "widget.key-statistics.list.entries": "Wpisy",
  "widget.key-statistics.list.locales": "Języki",
  "widget.key-statistics.list.webhooks": "Webhooki",
  "widget.key-statistics.title": "Statystyki projektu",
  "widget.last-activity.link": "Otwórz logi",
  "widget.last-activity.no-activity": "Brak aktywności",
  "widget.last-activity.title": "Ostatnia aktywność",
...
//# sourceMappingURL=pl.json-MMLEVPDT.js.map
