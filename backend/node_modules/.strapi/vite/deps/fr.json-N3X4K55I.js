...
var fr = {
  ...
  "actions-drawer.open": "Ouvrir plus d'actions",
  "actions-drawer.close": "Fermer plus d'actions",
  "actions.clone.error": "Une erreur s'est produite lors du clonage du document.",
  "actions.clone.label": "Dupliquer",
  "actions.delete.dialog.body": "Voulez-vous vraiment supprimer ce document ? Cette action est irréversible.",
  "actions.delete.error": "Une erreur s'est produite lors de la suppression du document.",
  "actions.discard.label": "Rejeter les modifications",
  "actions.discard.dialog.body": "Voulez-vous vraiment annuler les modifications ? Cette action est irréversible.",
  "actions.edit.error": "Une erreur s'est produite lors de la modification du document.",
  "actions.edit.label": "Editer",
  "actions.unpublish.error": "Une erreur s'est produite lors de la dépublication du document.",
  "actions.unpublish.dialog.body": "Voulez-vous vraiment dépublier ce document ?",
  "actions.unpublish.dialog.option.keep-draft": "Dépublier et conserver le dernier brouillon",
  "actions.unpublish.dialog.option.replace-draft": "Dépublier et remplacer le dernier bouillon",
  "ListViewTable.relation-loading": "Les relations sont en cours de chargement",
  "ListViewTable.relation-more": "Cette relation contient plus d'entités que celles affichées",
  "components.Filters.usersSelect.label": "Rechercher et sélectionner un utilisateur pour le filtrer",
  "components.RelationInput.icon-button-aria-label": "Glisser",
  "bulk-unpublish.already-unpublished": "Déjà non publié",
  "containers.edit.tabs.label": "Statut du document",
  "containers.edit.tabs.draft": "brouillon",
  "containers.edit.tabs.published": "publié",
  "containers.edit.panels.default.title": "Entrée",
  "containers.edit.panels.default.more-actions": "Plus d'actions sur les documents",
  "containers.edit.title.new": "Créer une entrée",
  "containers.edit.header.more-actions": "Plus d'actions",
  "containers.edit.information.last-published.label": "Publié",
  "containers.edit.information.last-draft.label": "Mise à jour",
  "containers.edit.information.document.label": "Créée",
  "containers.list.table.row-actions": "Ligne d'actions",
  "containers.list.autoCloneModal.header": "Dupliquer",
  "containers.list.autoCloneModal.title": "Cette entrée ne peut pas être dupliquée directement ",
  "containers.list.autoCloneModal.description": "Une nouvelle entrée sera créée avec le même contenu, mais vous devrez modifier les champs suivants pour l'enregistrer.",
  "containers.list.autoCloneModal.create": "Créer",
  "containers.list-settings.modal-form.label": "Modifier {fieldName}",
  "containers.list-settings.modal-form.error": "Une erreur s'est produite lors de l'ouverture du formulaire.",
  "containers.edit-settings.modal-form.error": "Une erreur s'est produite lors de l'ouverture du formulaire.",
  "containers.edit-settings.modal-form.label": "Libellé",
  ...
  "dnd.grab-item": "{item}, saisi. Position actuelle dans la liste : {position}. Appuyez sur les flèches haut et bas pour changer de position, sur la barre d'espacement pour déposer, sur Echap pour annuler.",
  "dnd.instructions": "Appuyez sur la barre d'espace pour saisir et réorganiser",
  "dnd.reorder": "{item}, déplacé. Nouvelle position dans la liste : {position}.",
  "error.records.fetch-draft-relatons": "Une erreur s'est produite lors de la recherche de relations brouillon sur ce document.",
  "popUpWarning.bodyMessage.contentType.delete": "Êtes-vous sûr de supprimer le Content-Type ?",
  "popUpWarning.bodyMessage.contentType.delete.all": "Voulez-vous vraiment supprimer ces entrées ?",
  "popUpWarning.bodyMessage.contentType.publish.all": "Voulez-vous vraiment publier ces entrées ?",
  "popUpWarning.bodyMessage.contentType.unpublish.all": "Voulez-vous vraiment dépublier ces entrées ?",
  "popUpWarning.warning.updateAllSettings": "Cela modifiera tous vos paramètres",
  "preview.content.close-editor": "Fermer l'éditeur",
  "preview.content.open-editor": "Ouvrir l'éditeur",
  "relation.error-adding-relation": "Une erreur s'est produite lors de l'ajout de la relation.",
  "reviewWorkflows.stage.label": "Phase d'examen",
  "success.record.clone": "Document cloné",
  "success.record.discard": "Modifications rejetées",
  "success.record.publishing": "Publication...",
  "success.records.delete": "Supprimé avec succès.",
  "success.records.unpublish": "Dépublication avec succès.",
  "history.document-action": "Historique du contenu",
  "history.page-title": "Historique de {contentType}",
  "history.sidebar.title": "Versions",
  "history.content.new-field.title": "Nouveau champ",
  "history.content.unknown-fields.title": "Champs inconnus",
  "history.content.localized": "Cette valeur est spécifique à cette locale. Si vous restaurez cette version, le contenu ne sera pas remplacé pour les autres locales.",
  "history.content.not-localized": "Cette valeur est commune à toutes les locales. Si vous restaurez cette version, le contenu sera remplacé pour toutes les locales.",
  "history.restore.error.message": "Impossible de restaurer la version.",
  "validation.error": "Votre document contient des erreurs de validation. Veuillez les corriger avant de l'enregistrer.",
  "bulk-publish.edit": "Editer"
};
export {
  fr as default,
  groups,
...
//# sourceMappingURL=fr.json-N3X4K55I.js.map
