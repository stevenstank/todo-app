...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/pl.json":
      return import("./pl.json-SZGE2XO4.js");
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        Component: () => import("./Roles-W77H3JZU.js"),
      ...
      },
      {
        ...
        Component: () => import("./Providers-NR3JW7Q3.js"),
      ...
      },
      {
        ...
        Component: () => import("./EmailTemplates-OJ26CFUY.js").then((mod) => ({
      ...
      },
      {
        ...
        Component: () => import("./AdvancedSettings-BOOOJXK4.js").then((mod) => ({
