...
import { Status, Flex, Typography, Link, SingleSelectOption, Box, Dialog, Field, SingleSelect, Button, Modal } from '@strapi/design-system';
import { Loader, Trash, Sparkle, WarningCircle, Earth, Plus, ListPlus, Cross } from '@strapi/icons';
...
import { useLazyGetFillFromLocaleDataQuery } from '../services/fillFromLocale.mjs';
