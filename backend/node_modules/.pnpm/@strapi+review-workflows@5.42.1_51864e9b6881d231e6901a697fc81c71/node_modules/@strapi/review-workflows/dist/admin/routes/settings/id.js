...
const havePermissionsChanged = (before, after)=>{
    if (before?.length !== after?.length) {
        return true;
    }
    return !before?.every((beforePermission)=>after?.some((afterPermission)=>afterPermission.role === beforePermission.role));
};
/* -------------------------------------------------------------------------------------------------
 * EditPage
 * -----------------------------------------------------------------------------------------------*/ const WORKFLOW_SCHEMA = yup__namespace.object({
    ...
    stages: yup__namespace.array().of(yup__namespace.object().shape({
        ...
        fromPermissions: yup__namespace.array(yup__namespace.object({
        ...
        toPermissions: yup__namespace.array(yup__namespace.object({
            role: yup__namespace.number().strict().typeError({
                id: 'review-workflows.validation.stage.permissions.role.number',
                defaultMessage: 'Role must be of type number'
            }).required(),
                        ...
                        children: [
                            /*#__PURE__*/ jsxRuntime.jsx(Layout.Header, {
                                ...
                                /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
                                    ...
                                    children: /*#__PURE__*/ jsxRuntime.jsx(strapiAdmin.BackButton, {
                                        fallback: ".."
                                    })
                                }),
