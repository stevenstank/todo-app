...
import { LANGUAGE_LOCAL_STORAGE_KEY, getStoredToken, THEME_LOCAL_STORAGE_KEY } from './reducer.mjs';
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case './translations/fi.json': return import('./translations/fi.json.mjs');
