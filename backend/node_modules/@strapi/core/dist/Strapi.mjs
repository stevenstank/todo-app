...
import getNumberOfConditionalFields from './services/utils/conditional-fields.mjs';
...
class Strapi extends Container {
   ...
   */ get entityService() {
    ...
    registerInternalServices() {
        ...
        }).add('reload', ()=>createReloader(this)).add('content-source-maps', ()=>createContentSourceMapsService(this));
    }
