    ...
    const primaryActionContent = /*#__PURE__*/ jsxs(Fragment, {
        children: [
            /*#__PURE__*/ jsx(Flex, {
                ...
                alignItems: "stretch",
                direction: "column",
                children: primaryAction.label === 'Publish' ? addHintTooltip(primaryAction, /*#__PURE__*/ jsx(DocumentActionButton, {
                    ...primaryAction,
    ...
    return /*#__PURE__*/ jsxs(Flex, {
        ...
        children: [
            ...
            secondaryAction ? /*#__PURE__*/ jsx(Flex, {
                ...
                alignItems: "stretch",
                direction: "column",
                children: secondaryAction.label === 'Publish' ? /*#__PURE__*/ jsx(tours.contentManager.Publish, {
 ...
 * -----------------------------------------------------------------------------------------------*/ const PublishAction = ({ activeTab, documentId, model, collectionType, meta, document })=>{
    ...
    useForm('PublishAction', ({ initialValues })=>initialValues);
