...
import { Flex, TextButton, EmptyStateLayout, Field, VisuallyHidden, Box, useComposedRefs, IconButton, Combobox, ComboboxOption, Typography, Link as Link$1 } from '@strapi/design-system';
import { ArrowClockwise, WarningCircle, Drag, Cross, Link, Plus } from '@strapi/icons';
...
const RelationsList = ({ data, serverData, disabled, name, isLoading, relationType, targetModel, documentParams, mainField })=>{
    ...
    const getItemPos = React.useCallback((index)=>`${index + 1} of ${data.length}`, [
        data.length
    ]);
...
`;
const ListItem = /*#__PURE__*/ React.memo(({ data, index, style })=>{
   ...
   */ const collectionType = getCollectionType(href);
    ...
    return /*#__PURE__*/ jsx(Box, {
        ...
        children: isDragging ? /*#__PURE__*/ jsx(RelationItemPlaceholder, {}) : /*#__PURE__*/ jsxs(RelationRow, {
            paddingTop: 2,
            paddingBottom: 2,
...
`;
const LinkEllipsis = styled(Link$1)`
  display: block;
