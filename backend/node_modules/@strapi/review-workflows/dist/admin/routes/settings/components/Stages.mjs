...
import { Flex, Box, useComposedRefs, VisuallyHidden, Accordion, Menu, IconButton, Grid, Field, TextInput, MultiSelect, MultiSelectGroup, Dialog, SingleSelect, SingleSelectOption, MultiSelectOption } from '@strapi/design-system';
...
`;
const Stage = ({ index, canDelete = false, canReorder = false, canUpdate = false, stagesCount, name, fromPermissions, toPermissions, color, defaultOpen })=>{
...
const PermissionsField = ({ label, disabled, name, placeholder, required })=>{
    const { formatMessage } = useIntl();
